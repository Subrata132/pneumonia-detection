...
if (retrain==True):
    ...
    saved_file=curdir+"/model/"+"xNet_2_class.hdf5" #While retraining change the name 
    ...
    saved_model=curdir+"/model/"+"xNet_2_class.hdf5"
...
for number in random_num:
    ...
    plt.subplot(3,4,i).set_title("True Label : "+str(Alabel)+" Predicted Label : "+str(Plabel))
    i=i+1
